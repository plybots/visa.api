...
public class PullFundsPostPayload {
  ...
  **/
  @ApiModelProperty(value = "<b>Note:</b></b> If provided, then the value overrides the one present in onboarding data. If the merchantCategoryCode value is not populated in onboarding data then this field is mandatory.<br><br>If not provided, then the value will default to the values provided during onboarding (when the services are provisioned).")
  ...
  **/
  ...
  public PullFundsPostPayload amount(BigDecimal amount) {
    this.amount = amount;
    return this;
  }
  ...
  **/
  ...
  public PullFundsPostPayload nationalReimbursementFee(BigDecimal nationalReimbursementFee) {
  ...
  **/
  ...
  public PullFundsPostPayload foreignExchangeFeeTransaction(BigDecimal foreignExchangeFeeTransaction) {
